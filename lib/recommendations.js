...
export async function recommendedForYou(
  ...
  // 7. Language Preference Discovery (Weight: 1.6) - NEW
  // If user has set preferred languages, explicitly fetch some top movies in those languages
  ...
  // If no language preferences, just return top 25
